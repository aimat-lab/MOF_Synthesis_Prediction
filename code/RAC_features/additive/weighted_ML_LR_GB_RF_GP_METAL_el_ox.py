...
#########################################################################
    ...
    #y_pred_train_unscaled = y_scaler.inverse_transform(y_pred_train)
        ...
        #np.savetxt("%s/predictions_rawdata/y_real_test.txt"%(outdir), y_test)
        #np.savetxt("%s/predictions_rawdata/y_real_train.txt"%(outdir), y_train)
        #np.savetxt("%s/predictions_rawdata/y_RFR_pred_test.txt"%(outdir), y_pred_test)
        #np.savetxt("%s/predictions_rawdata/y_RFR_pred_train.txt"%(outdir), y_pred_train)
        np.savetxt("./predictions_rawdata/y_real_"+str(counter)+"_test.txt", y_test)
        np.savetxt("./predictions_rawdata/y_real_"+str(counter)+"_train.txt", y_train)
        np.savetxt("./predictions_rawdata/y_RFR_"+str(counter)+"_test.txt", y_pred_test)
        np.savetxt("./predictions_rawdata/y_RFR_"+str(counter)+"_train.txt", y_pred_train)
