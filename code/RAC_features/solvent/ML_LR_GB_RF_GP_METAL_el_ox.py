...
def train(df, target, hparam):
    ...
    #y_scaler = StandardScaler()
        y_scaler = StandardScaler()
    #df_sol = pd.read_csv("avg_scales_param.csv")
        fe_sol=["param1"]
    ...
    #fe_sol=["param6"]
    #y_unscaled_feat_6=(df[fe_sol].values.reshape(-1,1))
    #fe_sol=["param7"]
    #y_unscaled_feat_7=(df[fe_sol].values.reshape(-1,1))
    #fe_sol=["param8"]
    #y_unscaled_feat_8=(df[fe_sol].values.reshape(-1,1))
    #fe_sol=["param9"]
    #y_unscaled_feat_9=(df[fe_sol].values.reshape(-1,1))
    #fe_sol=["param10"]
    #y_unscaled_feat_10=(df[fe_sol].values.reshape(-1,1))

    #y_unscaled=np.hstack([y_unscaled_feat_1,y_unscaled_feat_2,y_unscaled_feat_3,y_unscaled_feat_4,y_unscaled_feat_5,y_unscaled_feat_6,y_unscaled_feat_7,y_unscaled_feat_8,y_unscaled_feat_9,y_unscaled_feat_10])
...
def main(calcdir):
    ...
    df = pd.read_csv("extended_big_one_solvent.csv")
